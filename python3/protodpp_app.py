...
class ProtoDPP(TKApp):
	...
	def configure_ui(self):
		...
		# Buttons
		self.onboard_button = self.buttons_window.add_button(0, 'onboard2.png', self.click_onboard)
		...
		self.settings_button = self.buttons_window.add_button(2, 'settings2.png', self.click_settings)
